function Letter(l, lineNum) {
  ...
  this.ytrans = this.lineNum * kerning; //put it on the next line, this works
  ...
  this.display = function() {
    ...
    if (this.letter == 'a') {
      ...
      line(letterwidth / 2, 0, this.topEdge - this.xtransReverse, -this.ytrans - pushedheight); //but what happens outside of this instantiation?
      ...
      line(0, 0, this.topEdge - this.xtransReverse, -this.ytrans - pushedheight); //reverse translate the y
      ...
      strokeWeight(letterstrokeB);
      line(0, 0, this.topEdge - this.xtransReverse, -this.ytrans - pushedheight); //reverse translate the y
      line(0, letterheight, this.xtransReverse, height - pushedheight); //reverse translate the y
      pop();
    ...
    } else if (this.letter == 'h') {} else if (this.letter == 'i') {} else if (this.letter == 'j') {} else if (this.letter == 'k') {} else if (this.letter == 'l') {} else if (this.letter == 'm') {} else if (this.letter == 'n') {} else if (this.letter == 'o') {} else if (this.letter == 'p') {} else if (this.letter == 'q') {} else if (this.letter == 'r') {} else if (this.letter == 's') {} else if (this.letter == 't') {} else if (this.letter == 'u') {} else if (this.letter == 'v') {} else if (this.letter == 'w') {} else if (this.letter == 'x') {} else if (this.letter == 'y') {} else if (this.letter == 'z') {}
  }
...
function LetterA(lineNum) {
  ...
  this.display = function(x, y) {
    ...
    push();
    translate(x + sliderLR.value(), y + this.lineNum * kerning);
    noFill();
    strokeWeight(letterstroke);
